...
public:
    VideoPublisher() : Node("video_publisher_node") {
        ...
        // 비디오 파일 열기
        //cap_.open("/home/rapi5/simulation/5_lt_cw_100rpm_out.mp4"); 
        // cap_.open("/home/rapi5/simulation/lanefollow_100rpm_ccw.mp4"); 
        // cap_.open("/home/rapi5/simulation/5_lt_cw_100rpm_out.mp4"); 
        cap_.open("/home/rapi5/simulation/7_lt_ccw_100rpm_in.mp4"); 
        if (!cap_.isOpened()) {
